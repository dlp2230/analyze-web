    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <a href="/config/menu/list?level=2&pid=<?php echo $ppid; ?>" class="btn btn-info"
                   role="button">
                ...
                <div style="display: inline-block"><span class="text-red"><strong>注:</strong>3级菜单位于系统的左侧!</span></div>
