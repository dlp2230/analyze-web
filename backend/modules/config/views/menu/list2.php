    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <a href="/config/menu/list?level=1" class="btn btn-info"
                   role="button">
                    <span class="glyphicon glyphicon-arrow-left"></span>
                    返回
                </a>
                <a href="#" data-level="<?php echo $level; ?>" data-pid="<?php echo $pid; ?>"
                   class="btn btn-primary menu-add need-check"
                   data-permid="<?php echo \backend\libraries\CheckPerm::createItem('CONFIG_MENU_ADD'); ?>">
                    新增2级菜单
                </a>

                <div style="display: inline-block"><span class="text-red"><strong>注:</strong>2级菜单位于系统的左侧!</span></div>
                    ...
                    <table class="table table-bordered">
                        ...
                        foreach ($list as $menu) {
                            ...
                            <tr>
                                ...
                                <?php if ($menu['is_menu']): ?>
                                    <td>
                                        <a href="<?php echo '/config/menu/list?level=3&pid=' . $menu['id']; ?>"
