<form action="" method="get" class="form-inline well" role="form" id="search_form_ajax">
    ...
    <div class="form-group">
        <lable>结束日期：</lable>
        <input type="text" value="<?php echo Yii::$app->request->get('end_time')?Yii::$app->request->get('end_time'):date('Y-m-d 23:00');?>" readonly class="form-control" id="end_time" name="end_time">
    </div>
