 ...
 */
class CacheRetainedRole extends \common\libraries\base\ActiveRecord
{
     ...
     * @return User|null
     */
    public static function getRole($ts,$game_id,$server_id,$channel_id=0,$dayNum=2)
    {
        $where = [
            'ts'=>intval($ts),
     ...
     *设置留存
     * **/
    public static function setRole($ts,$game_id,$server_id,$channel_id=0,$dayNum,$param){
