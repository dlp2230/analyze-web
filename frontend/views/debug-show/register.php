...
<form action="" method="get" class="form-inline well" role="form" id="search_form_ajax">
    <div class="form-group">
        <lable>游戏ID：</lable>
        <input type="number" value=""  class="form-control" id="game_id" name="game_id" placeholder="请输入游戏ID">
    </div>
    <div class="form-group">
        <lable>区服ID：</lable>
        <input type="number" value=""  class="form-control" id="server_id" name="server_id" placeholder="请输入区服ID">
    </div>
    <div class="form-group">
        <lable>角色ID：</lable>
        <input type="text" value=""  class="form-control" id="role_id" name="role_id" placeholder="请输入角色ID">
    </div>
    <div class="form-group">
